...
const triggerEventsByApp: Record<string, Array<{ value: string; label: string; icon: any }>> = {
  ...
  discord: [
    ...
    { value: "user-joined", label: "User Joined Server", icon: MessageSquare },
    { value: "reaction-added", label: "Reaction Added to Message", icon: MessageSquare },
  ],
  telegram: [
    { value: "new-message", label: "New Message Received", icon: Send },
    { value: "bot-command", label: "Bot Command Received", icon: Send },
    { value: "file-received", label: "File Received", icon: Send },
    { value: "group-message", label: "New Group Message", icon: Send },
  ],
  notion: [
    { value: "page-created", label: "New Page Created", icon: FileText },
    { value: "page-updated", label: "Page Updated", icon: FileText },
    { value: "database-item-added", label: "Database Item Added", icon: FileText },
    { value: "page-shared", label: "Page Shared", icon: FileText },
  ],
  stripe: [
  ...
  "wallet-tracking": [
    ...
    { value: "token-received", label: "Token Received", icon: TrendingUp },
  ],
  portfolio: [
    { value: "value-changed", label: "Portfolio Value Changed", icon: BarChart3 },
    { value: "asset-threshold", label: "Asset Price Threshold", icon: BarChart3 },
    { value: "rebalance-needed", label: "Rebalancing Needed", icon: BarChart3 },
  ],
}
